package com.superc.lib.widget.floatingbutton;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private int mAddButtonPlusColor = ContextCompat.getColor(getContext(), android.R.color.white);
    ...
    private OnFloatingMenuItemClickListener mMenuItemClickListener;
    ...
    public interface OnFloatingMenuItemClickListener {
        void onMenuItemClick(FloatingActionButton btn, int position);
    }
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        initDefaultValue(context, attributeSet);
    }

    private void initDefaultValue(Context context, AttributeSet attributeSet) {
    ...
    public void setMenuItemClickListener(OnFloatingMenuItemClickListener menuItemClickListener) {
    ...
    public void setAddButtonStrokeVisible(boolean mAddButtonStrokeVisible) {
        this.mAddButtonStrokeVisible = mAddButtonStrokeVisible;
    }

    public void setResIcon(int mResIcon) {
    ...
    public void resetView() {
        initDefaultValue(getContext(), mAttr);
    }

    private void setOnClick() {
        if (getChildCount() == 0) {
            throw new RuntimeException("You must add FloatingActionButton in your xml file");
        }
        for (int i = 0; i < getChildCount(); i++) {
            View v = getChildAt(i);
            if (v != null && (!(v instanceof AddFloatingActionButton)) && (v instanceof FloatingActionButton)) {
                final FloatingActionButton b = (FloatingActionButton) v;
                final int finalI = i;
                b.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mMenuItemClickListener.onMenuItemClick(b, finalI);
                    }
                });
            }
        }
